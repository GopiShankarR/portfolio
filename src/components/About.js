      ...
      <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
        <div className="about-info">
          ...
          <p className="font-serif pb-5">
            Hi, My Name Is Gopi Shankar Ravady. I am a Full Stack Developer with a zest for learning new tech and getting updated with technology every day.
          </p>
          <p className="font-serif pb-5">
            I am proficient in Frontend skills like Vue.js, Flutter, HTML, CSS, JavaScript, and Tailwind CSS, and currently, I'm learning React.js.
          </p>
